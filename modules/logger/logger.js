    ...
    */
    ...
    this.init = function init(options){
        ...
        if (typeOfenabled === 'boolean'){
            ...
            throw 'BaseLogger :: illegal type for enabled - expected boolean, got ' + typeOfenabled;
        }
        ...
        */
        if (typeOfLevel === 'string'){
            if (levels.indexOf(options.level) === -1){
                throw 'Logger :: unknown level ' + options.level;
            } else {
            ...
            throw 'BaseLogger :: illegal type for level - expected string, got ' + typeOfLevel;
        }
        ...
        */
        if (typeOfLevels === 'object'){
            ...
            throw 'BaseLogger :: illegal type for levels - expected object, got ' + typeOfLevels;
        }
        ...
        */
        if (typeOfEmit === 'function'){
            ...
            throw 'BaseLogger :: illegal type for emit - expected function, got ' + typeOfEmit;
        }
    }
